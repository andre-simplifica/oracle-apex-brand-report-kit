...
def runtime_labels(language: str) -> dict[str, str]:
    """Return the generated runtime copy for a supported locale family."""
    if language.lower().startswith("pt"):
        return {
            "LABEL_REPORT_ACTIONS": "Ações do relatório",
            "LABEL_FULLSCREEN": "Tela cheia",
            "LABEL_PRINT": "Imprimir",
            "LABEL_SAVE_PDF": "Salvar em PDF",
            "LABEL_GENERATED_AT": "Emitido em",
            "LABEL_GENERATED_BY": "Emitido por",
            "DATETIME_FORMAT": "DD/MM/YYYY HH24:MI TZH:TZM",
            "ERROR_TITLE": "Relatório indisponível",
            "ERROR_TEXT": "Não foi possível preparar este relatório. Tente novamente ou entre em contato com o suporte",
            "ERROR_REFERENCE": "e informe a referência",
            "DEFAULT_FILENAME": "relatorio.pdf",
            "EXAMPLE_REPORT_TITLE": "Título do relatório",
            "EXAMPLE_REPORT_SUBTITLE": "Contexto de negócio",
            "EXAMPLE_SUMMARY": "Resumo",
            "EXAMPLE_METRIC": "Indicador de exemplo",
            "EXAMPLE_METRIC_NOTE": "Substitua por conteúdo de negócio autorizado",
            "EXAMPLE_EMPTY_TITLE": "Nenhum dado disponível",
            "EXAMPLE_EMPTY_TEXT": "Aplique os filtros do relatório para exibir os dados autorizados.",
        }
    return {
        "LABEL_REPORT_ACTIONS": "Report actions",
        "LABEL_FULLSCREEN": "Full screen",
        "LABEL_PRINT": "Print",
        "LABEL_SAVE_PDF": "Save as PDF",
        "LABEL_GENERATED_AT": "Generated at",
        "LABEL_GENERATED_BY": "Generated by",
        "DATETIME_FORMAT": "YYYY-MM-DD HH24:MI TZH:TZM",
        "ERROR_TITLE": "Report unavailable",
        "ERROR_TEXT": "We could not prepare this report. Please try again or contact support",
        "ERROR_REFERENCE": "and mention reference",
        "DEFAULT_FILENAME": "report.pdf",
        "EXAMPLE_REPORT_TITLE": "Report title",
        "EXAMPLE_REPORT_SUBTITLE": "Business-safe context",
        "EXAMPLE_SUMMARY": "Summary",
        "EXAMPLE_METRIC": "Example metric",
        "EXAMPLE_METRIC_NOTE": "Replace with authorized business content",
        "EXAMPLE_EMPTY_TITLE": "No data yet",
        "EXAMPLE_EMPTY_TEXT": "Apply the report filters to display authorized data.",
    }
...
def token_values(config: dict[str, Any], profile: dict[str, Any]) -> dict[str, str]:
    ...
    labels = {key: sql_literal(value) for key, value in runtime_labels(config["locale"]["language"]).items()}
    return {
